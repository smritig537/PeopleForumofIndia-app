...
function Footer() {
  return (
           <>
           <footer className='w-[100vw] text-[13px] md:text-[15px]  xl:text-[17px] h-auto flex  items-center justify-center bg-[#414542]'>
          <div className='w-[90%]  m-auto h-[100%] flex  flex-col '>
            <div className='flex flex-col   md:flex-row justify-between mt-8'>
                 <img src={logo} className='w-[350px] h-[350px] mx-auto mt-0' />
                 <div className='flex flex-col text-center mb-8'>
                     <h1 className='font-bold text-center text-[#d6924d]'>Quick Links</h1>
                     <p>Home</p>
                     <p>About</p>
                     <p>Our Team</p>
                     <p>Services</p>
                 ...
                 <div className='flex flex-col mb-8'>
                       <h1 className='font-bold text-center text-[#d6924d]'>Address:</h1>
                       <p className='w-[80%] text-center'>4690/2, Shora Kothi, Near Main Market, Pahar Ganj, New Delhi-110055</p>
                 </div>
                 <div className='flex flex-col text-center mb-8'>
                      <h1 className='font-bold text-[#d6924d]'>Get In Touch</h1>
